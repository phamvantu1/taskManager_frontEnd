...
// const ProgressChart: React.FC<ProgressChartProps> = ({ departmentId, progressDateRange }) => {
...
//         <button
//           onClick={() => fetchProgressData(1)} // Reset to first page on manual search
...
//           </div>
//         ) : (
//           <p>Chưa có dữ liệu tổng quan. Vui lòng nhấn "Tìm kiếm".</p>
//         )}
//       </div>
...
//               {Math.min(currentPage * itemsPerPage, progressData.totalElements)} trong tổng số {progressData.totalElements} nhân viên
//             </div>
//           )}
//         </div>
...
//           </div>
//         ) : (
//           <p>Chưa có dữ liệu tiến độ. Vui lòng nhấn "Tìm kiếm".</p>
//         )}
//       </div>
